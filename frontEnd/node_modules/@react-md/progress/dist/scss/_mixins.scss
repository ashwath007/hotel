...
@mixin rmd-circular-progress {
  .rmd-circular-progress {
    ...
    @if $rmd-circular-progress-small-size != null {
      &--small {
        @include rmd-progress-theme-update-var(circular-size, $rmd-circular-progress-small-size);
      }
    }
    ...
    &__svg {
      ...
      &--indeterminate {
        animation: rmd-progress-rotate $rmd-circular-progress-transition-duration linear infinite;
      }
    }
    ...
    &__circle {
      ...
      &--indeterminate {
        animation: rmd-circular-progress-size $rmd-circular-progress-transition-duration ease-in-out
          infinite;
      }
    }
  }
