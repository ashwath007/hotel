...
var TextFieldContainer_1 = __importDefault(require("./TextFieldContainer"));
var useValuedState_1 = __importDefault(require("./useValuedState"));
var FormThemeProvider_1 = require("../FormThemeProvider");
var block = utils_1.bem("rmd-textarea");
var container = utils_1.bem("rmd-textarea-container");
...
var TextArea = react_1.forwardRef(function TextArea(_a, forwardedRef) {
    ...
    var _m = FormThemeProvider_1.useFormTheme({
        theme: propTheme,
        underlineDirection: propUnderlineDirection,
    }), theme = _m.theme, underlineDirection = _m.underlineDirection;
    var _o = useFocusState_1.default({
        onBlur: propOnBlur,
        onFocus: propOnFocus,
    }), focused = _o[0], onFocus = _o[1], onBlur = _o[2];
    var _p = react_1.useState(), height = _p[0], setHeight = _p[1];
    ...
    return (react_1.default.createElement(TextFieldContainer_1.default, { style: __assign(__assign({}, style), { height: height
                ? "calc(" + PADDING_VARIABLES + " + " + height + "px)"
                : undefined }), className: classnames_1.default(container({
        ...
        react_1.default.createElement(FloatingLabel_1.default, { style: labelStyle, className: labelClassName, htmlFor: id, error: error, active: focused, floating: focused || valued, valued: valued, dense: dense, disabled: disabled }, label),
        children));
});
