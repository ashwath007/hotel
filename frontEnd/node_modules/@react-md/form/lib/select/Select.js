...
var FloatingLabel_1 = __importDefault(require("../label/FloatingLabel"));
var TextFieldContainer_1 = __importDefault(require("../text-field/TextFieldContainer"));
var useFocusState_1 = __importDefault(require("../useFocusState"));
var Listbox_1 = __importDefault(require("./Listbox"));
var utils_2 = require("./utils");
var FormThemeProvider_1 = require("../FormThemeProvider");
var block = utils_1.bem("rmd-select");
/**
 ...
 */
var Select = react_1.forwardRef(function Select(_a, forwardedRef) {
    ...
    var id = props.id;
    var rightChildren = icon_1.useIcon("dropdown", propRightChildren);
    var _x = FormThemeProvider_1.useFormTheme({
        theme: propTheme,
        underlineDirection: propUnderlineDirection,
    }), theme = _x.theme, underlineDirection = _x.underlineDirection;
    var valued = typeof value === "number" || !!value;
    var displayValue = react_1.useMemo(function () {
    ...
    var _y = utils_1.useToggle(false), visible = _y[0], show = _y[1], hide = _y[2];
    var _z = useFocusState_1.default({ onBlur: onBlur, onFocus: onFocus }), focused = _z[0], handleFocus = _z[1], handleBlur = _z[2];
    ...
    var handleKeyboardClose = react_1.useCallback(function () {
        hide();
        if (ref.current) {
            ref.current.focus();
        }
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(TextFieldContainer_1.default, __assign({}, props, { "aria-haspopup": "listbox", "aria-disabled": disabled || undefined, ref: refHandler, role: "button", tabIndex: disabled ? undefined : 0, label: !!label, onFocus: handleFocus, onBlur: handleBlur, onKeyDown: disabled ? undefined : handleKeyDown, onClick: disabled ? undefined : handleClick, theme: theme, error: error, active: focused || visible, inline: inline, disabled: disabled, underlineDirection: underlineDirection, isLeftAddon: isLeftAddon, isRightAddon: isRightAddon, rightChildren: rightChildren, className: classnames_1.default(block({ disabled: disabled }), className) }),
            ...
            react_1.default.createElement("span", { id: displayValueId, style: displayLabelStyle, className: classnames_1.default(block("value", {
                    disabled: disabled,
                    readonly: readOnly,
