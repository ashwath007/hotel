...
var useTabIndicatorStyle_1 = __importStar(require("./useTabIndicatorStyle"));
var useTabsMovement_1 = __importDefault(require("./useTabsMovement"));
 ...
 */
var TabsList = react_1.forwardRef(function TabsList(_a, forwardedRef) {
    var _b;
    ...
    var _h = useTabsMovement_1.default({
        onClick: onClick,
        onKeyDown: onKeyDown,
        children: children,
    ...
    var _j = useTabIndicatorStyle_1.default({
        style: style,
        ref: forwardedRef,
        align: align,
        itemRefs: itemRefs,
