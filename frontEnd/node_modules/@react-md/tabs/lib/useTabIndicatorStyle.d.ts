...
declare type ReturnValue = [CSSProperties, MergedTabRef, MutableRefObject<HTMLDivElement | null>, UpdateIndicatorStyles];
/**
 * @since 2.3.0
 * @private
 * @internal
 ...
 * @private
 */
export default function useTabIndicatorStyle({ style, ref: propRef, align, itemRefs, totalTabs, activeIndex, }: Options): ReturnValue;
export {};
