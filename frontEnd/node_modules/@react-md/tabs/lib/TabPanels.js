...
var PanelGroup_1 = __importDefault(require("./PanelGroup"));
 ...
 */
var TabPanels = react_1.forwardRef(function TabPanels(_a, forwardedRef) {
    ...
    return (react_1.default.createElement("div", __assign({}, props, { ref: refHandler, className: classnames_1.default(block({
        ...
        react_1.default.createElement(PanelGroup_1.default, { persistent: persistent, disableTransition: disableTransition }, react_1.Children.map(children, function (child, index) {
